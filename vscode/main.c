...
int main(int argc, char *argv[]) {
    ...
    char bdinfo_encrypted[BDINFO_LEN] = {0};
    char bdinfo_decrypted[BDINFO_LEN] = {0};
    size_t read_bytes;
    FILE *bdinfo_input;
    int ret = 0;
    int c;
    ...
    bdargs.input_file = "C:\\Users\\yiner\\Documents\\cudy\\c\\bdinfo.bin";
    //bdargs.output_file = "C:\\Users\\yiner\\Documents\\cudy\\c\\bdinfo.txt";
    bdargs.skip_rsa = 0;
